...
1. Clone o repositório do Projeto [Blog Pessoal](https://github.com/Wezzlim/blogpessoal_spring) dentro da pasta do *Workspace* do STS
 
```bash
git clone https://github.com/Wezzlim/blogpessoal_spring.git
```
...
Desenvolvido por [**Wesley**](https://github.com/Wezzlim)
