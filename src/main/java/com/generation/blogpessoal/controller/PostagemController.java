...
@CrossOrigin(origins = "*", allowedHeaders = "*") // habilitar o cabeçalho pra liberar o token
public class PostagemController {
	...
	@GetMapping("/{id}") //definindo variavel, pegando do caminho com pathvariable, se tiver 2 tem que charma-lo novamente
